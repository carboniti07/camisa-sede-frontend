  ...
  return (
    <section className="relative w-full overflow-hidden bg-transparent">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-12 md:grid-cols-2 md:px-8 lg:py-20">
        <div>
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.35em] text-cyan-700">A peça</p>
          ...
          <div className="mt-8 grid max-w-md grid-cols-3 gap-5 text-sm">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.35em] text-slate-500">Edição</p>
              <p className="mt-2 font-semibold text-slate-950">Limitada</p>
            </div>

            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.35em] text-slate-500">Tamanhos</p>
              <p className="mt-2 font-semibold text-slate-950">PP a G4</p>
            </div>

            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.35em] text-slate-500">Pagamento</p>
